...
const ProcessSection: React.FC = () => {
  return (
    <section id="process" className="py-12 md:py-20 lg:py-24 bg-white border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Top Row: Header + Dashboard */}
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-start mb-16 md:mb-20">
