        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="flex-shrink-0 flex items-center justify-start flex-1 md:flex-none ml-2 md:ml-0">
              <Link to="/" className="flex items-center" aria-label="Flood Doctor Home">
                <img src="/assets/logo.png" alt="Flood Doctor" className="h-14 md:h-16 w-auto object-contain" />
              </Link>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-3">
              <a
                href="tel:8774970007"
                className={`flex items-center font-semibold transition-all px-3 py-2 rounded-full ${isEmergencyMode
            ...
            <div className="flex items-center md:hidden">
              <a
                href="tel:8774970007"
                className={`p-2 -mr-2 rounded-full focus:outline-none focus:ring-2 focus:ring-primary ${isEmergencyMode ? 'text-red-600 bg-red-50' : 'text-primary hover:bg-blue-50'
                  }`}
                aria-label="Call Now"
              >
