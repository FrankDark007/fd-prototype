...
const Footer: React.FC = () => {
  ...
  const serviceLinks = isCommercial ? [
    { label: 'Commercial Restoration', path: '/services/commercial/restoration-services/' },
    { label: 'Industrial Cleanup', path: '/services/commercial/cleanup-services/' },
    { label: 'Technical Services', path: '/services/commercial/technical-services/' },
    { label: 'All Commercial Services', path: '/services/commercial/' },
  ] : [
    { label: 'Water Damage', path: '/services/residential/water-damage-restoration/' },
    { label: 'Mold Remediation', path: '/services/residential/mold-remediation/' },
    { label: 'Fire Damage', path: '/services/residential/fire-smoke-restoration/' },
    { label: 'All Residential Services', path: '/services/residential/' },
  ];
    ...
    <footer className="bg-white border-t border-gray-200 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 md:py-16 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:gap-12 lg:gap-16">
          ...
          <MobileAccordionItem
            title={isCommercial ? "Commercial Services" : "Residential Services"}
          ...
          >
            <ul className="space-y-3">
              {serviceLinks.map(link => (
                <li key={link.path}>
                  <Link to={link.path} className="block text-sm text-gray-500 hover:text-primary transition-colors py-2 md:py-0">
                    {link.label}
                  </Link>
                </li>
              ))}
