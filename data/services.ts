...
export const SERVICES: ServiceData[] = [
  ...
  // 15. Commercial Water Damage
  {
    ...
    faqs: [
      { question: "How quickly do you respond to commercial water damage?", answer: "We offer 24/7 priority response for businesses in the DMV area. We aim to have a crew onsite within 60 minutes to minimize business interruption and inventory loss." },
      { question: "Can we stay open during the restoration process?", answer: "Often, yes. We use containment barriers, negative air pressure, and after-hours scheduling to isolate the work zone, allowing your business to continue operations safely in unaffected areas." },
      { question: "Do you have the capacity for large commercial floods?", answer: "Yes. We own industrial-grade equipment including trailer-mounted desiccant dehumidifiers and generators. We can scale our manpower to handle multi-story office buildings, warehouses, and retail complexes." },
      { question: "How do you handle insurance for commercial claims?", answer: "We assign a dedicated project manager to handle your claim. We use Xactimate to provide detailed documentation, moisture maps, and photos directly to your commercial insurance carrier." },
      { question: "Do you offer reconstruction services?", answer: "Yes. We are a licensed Class A contractor in Virginia. We provide turnkey solutions, handling everything from emergency water extraction to full reconstruction and build-back." },
      { question: "What about mold prevention in commercial buildings?", answer: "Fast drying is the key. We use commercial desiccants to lower humidity rapidly. We also apply antimicrobial treatments to prevent mold growth, protecting your employees and tenants." }
    ],
  ...
  // 16. Commercial Flood Cleanup
  {
    ...
    faqs: [
      { question: "How do you handle large-scale commercial flooding?", answer: "We deploy truck-mounted pumps and industrial extractors to remove thousands of gallons of water quickly. Our team size scales with the project to handle debris removal and muck-out efficiently." },
      { question: "Is flood water considered hazardous?", answer: "Yes. Flood water is typically Category 3 'Black Water', containing sewage, chemicals, and silt. We require full PPE for our crews and use hospital-grade disinfectants to sanitize the facility." },
      { question: "Do you clean up mud and sludge?", answer: "Yes. We shovel out mud and silt (muck-out) and then pressure wash concrete floors and structural elements to remove contaminants before drying begins." },
      { question: "Can you save flooded inventory?", answer: "It depends on the material. Non-porous items (metal, glass) can often be cleaned and sanitized. Porous packaging (cardboard) and consumables are usually considered total loss. We help inventory everything for your claim." },
      { question: "How long does it take to dry a flooded warehouse?", answer: "Drying time depends on humidity and materials. Concrete slabs hold moisture and take longer to dry. We use desiccant dehumidifiers to lower the vapor pressure and speed up evaporation, typically taking 5-7 days." },
      { question: "Do you provide temporary power?", answer: "Yes. If the flood has compromised your building's electrical system, we deploy commercial generators to run our drying equipment and provide lighting for the cleanup." }
    ],
  ...
  // 17. Large Loss Restoration
  {
    ...
    faqs: [
      { question: "What defines a 'Large Loss' project?", answer: "Large loss typically refers to disasters affecting commercial properties over 10,000 sq ft, involving critical infrastructure, or requiring substantial manpower/equipment (e.g., trailer-mounted desiccants) to restore." },
      { question: "Do you have the capacity for university or hospital disasters?", answer: "Yes. We have the resources to mobilize 50+ technicians and industrial drying equipment rapidly. We are experienced in working within secure, sensitive environments like hospitals and campuses." },
      { question: "How do you manage communication on large projects?", answer: "We assign a dedicated Project Manager and Site Supervisor. You receive daily briefings, Gantt chart timeline updates, and digital logs of all moisture readings and progress." },
      { question: "Can you provide temporary power and climate control?", answer: "Yes. We deploy large commercial generators and temporary HVAC units to maintain building operations and facilitate drying even if the facility's power is down." },
      { question: "Do you handle document and electronics recovery?", answer: "Yes. We coordinate specialized services including freeze-drying for wet documents and corrosion control cleaning for sensitive electronics and servers." },
      { question: "Are you insured for large commercial losses?", answer: "Yes. We carry high-limit liability, pollution, and workers' compensation insurance specifically designed for large-scale commercial restoration projects." }
    ],
  ...
  // 18. Commercial Sewage Cleanup
  {
    ...
    faqs: [
      { question: "How do you handle sewage cleanup in a restaurant?", answer: "Speed and discretion are key. We isolate the affected area with containment barriers, extract the waste, sanitize floors and drains, and use air scrubbers to remove odors. We can work overnight to minimize downtime." },
      { question: "Do you provide proof of sanitation for health inspectors?", answer: "Yes. We provide a detailed report including photos, processes used, and ATP test results verifying that the surfaces are clean and free of biological contaminants." },
      { question: "Can we keep the carpet after a sewage backup?", answer: "No. Commercial carpet and glue-down tiles contaminated by sewage (Category 3 water) must be removed and disposed of to ensure the safety of your employees and customers." },
      { question: "Is the sewage smell dangerous?", answer: "The smell indicates bacteria and gases. We treat the odor by removing the source and using industrial air scrubbers and hydroxyl generators to neutralize airborne pathogens and scent molecules." },
      { question: "Are your technicians certified for biohazard cleanup?", answer: "Yes. Our team is trained in OSHA bloodborne pathogen standards and IICRC protocols for sewage remediation. They wear full PPE to ensure safety." },
      { question: "Do you clean grease trap overflows?", answer: "Yes. We clean the spill and sanitize the area. However, the grease trap itself usually requires pumping by a septic/plumbing specialist, which we can coordinate." }
    ],
  ...
  // 19. Commercial Mold Remediation
  {
    ...
    faqs: [
      { question: "How do you handle mold remediation in an occupied office?", answer: "We use strict containment protocols. We build negative-pressure barriers with plastic sheeting to isolate the work area, ensuring mold spores do not spread to occupied parts of the building. We can also work after hours." },
      { question: "Is mold testing required for commercial properties?", answer: "We highly recommend third-party air quality testing before and after remediation. This provides liability protection and proof that the environment is safe for employees and tenants." },
      { question: "What causes mold in commercial buildings?", answer: "Common causes include HVAC malfunctions, roof leaks, plumbing failures, and high humidity in areas like restrooms or storage. We help identify and address the moisture source to prevent regrowth." },
      { question: "Do I need to close my business during mold removal?", answer: "Usually, no. Because we isolate the affected area, your business can often continue operations. However, if the mold is widespread or in critical areas (like a kitchen), temporary closure of that zone may be needed." },
      { question: "Can you clean mold from HVAC ducts?", answer: "Yes. Mold in the HVAC system spreads spores throughout the building. We clean the ducts and air handlers using specialized equipment and antimicrobials." },
      { question: "How long does commercial mold remediation take?", answer: "Small projects may take 2-3 days. Larger, systemic outbreaks can take 1-2 weeks. We provide a detailed schedule and can work continuously to expedite the process." }
    ],
    relatedSearchTerms: [
  ...
  // 20. Commercial Fire & Smoke
  {
    ...
    faqs: [
      { question: "How do you remove smoke smell from a commercial building?", answer: "We use a combination of source removal (cleaning soot), thermal fogging, and industrial hydroxyl or ozone generators. Cleaning the HVAC system is also critical to stop smoke from recirculating." },
      { question: "Can you clean electronics and machinery affected by smoke?", answer: "Yes. Soot is acidic and can corrode metal and circuitry. We coordinate immediate preservation and specialized cleaning for computers, servers, and manufacturing equipment." },
      { question: "What about water damage from the fire sprinklers?", answer: "Fire restoration often starts with water cleanup. We extract the water from sprinklers or fire hoses immediately to prevent mold, then dry the structure while cleaning the soot." },
      { question: "Do you provide document recovery services?", answer: "Yes. We can freeze-dry wet documents and clean soot-covered files to salvage critical business records." },
      { question: "How long will my business be closed?", answer: "It depends on the severity. We aim to isolate the damaged area so you can open unaffected parts of the facility sooner. We provide a project timeline upfront." },
      { question: "Do you handle the reconstruction?", answer: "Yes. We are a full-service restoration contractor. We can handle demolition, cleanup, and the complete rebuild of your commercial property." }
    ],
  ...
  // 21. Moisture Mapping
  {
    ...
    faqs: [
      { question: "What is moisture mapping?", answer: "Moisture mapping is a diagnostic process using thermal imaging and moisture meters to create a visual map of wet areas in a building. It identifies hidden water intrusion without destructive demolition." },
      { question: "How accurate is thermal imaging for leak detection?", answer: "Thermal imaging is highly effective at identifying temperature differentials caused by evaporation, which indicates moisture. We verify all thermal anomalies with physical moisture meters for 100% accuracy." },
      { question: "Do you provide a written report?", answer: "Yes. We provide a comprehensive PDF report including thermal images, digital photos, moisture readings, and a floor plan map of the affected areas, suitable for insurance claims or legal documentation." },
      { question: "Can you map moisture in a flat commercial roof?", answer: "Yes. We perform roof scans (typically at dusk) to identify areas of wet insulation under the membrane, helping you target repairs rather than replacing the entire roof." },
      { question: "Is this service disruptive to my business?", answer: "No. Moisture mapping is non-invasive and quiet. We can perform the inspection during business hours with minimal disruption to your operations." },
      { question: "Do you fix the leaks you find?", answer: "We are a restoration company, so we handle the drying and remediation. For the plumbing or roof repair itself, we can refer you to trusted specialized contractors." }
    ],
  ...
  // 22. Indoor Air Quality
  {
    ...
    faqs: [
      { question: "What does indoor air quality (IAQ) testing cover?", answer: "Our IAQ testing can include analysis for mold spores, volatile organic compounds (VOCs), particulates (dust), carbon dioxide/monoxide levels, humidity, and temperature to identify 'Sick Building Syndrome' causes." },
      { question: "How long does it take to get IAQ results?", answer: "Physical sampling takes a few hours. Laboratory analysis typically takes 2-3 business days, though rush processing is available for urgent situations." },
      { question: "Can you detect hidden mold with air testing?", answer: "Yes. Air sampling compares indoor spore counts to outdoor baselines. High levels of specific mold spores inside can indicate hidden growth behind walls or in HVAC systems." },
      { question: "Do you fix the air quality issues you find?", answer: "We identify the problem (e.g., mold, poor ventilation) and provide a protocol for fixing it. If it involves remediation or cleaning, we can perform that work. If it requires HVAC repair, we refer you to a specialist." },
      { question: "Is testing disruptive to office work?", answer: "No. Our sampling equipment is quiet and compact. We can perform testing during business hours with virtually no disruption to your staff." },
      { question: "Do you provide clearance testing after remediation?", answer: "Yes. Post-remediation verification (PRV) testing is crucial to document that the environment is safe and returned to normal fungal ecology." }
    ],
  ...
  // 23. Environmental Testing
  {
    ...
    faqs: [
      { question: "When is asbestos testing required?", answer: "Asbestos testing is typically required before any demolition or renovation in commercial buildings built before 1980 (and often later), to comply with OSHA and EPA regulations." },
      { question: "How do you test for sewage contamination?", answer: "We use ATP testing for immediate hygiene verification and lab cultures to identify specific bacteria like E. coli or Coliform, confirming if a spill is Category 3 (black water)." },
      { question: "Do you offer lead paint testing?", answer: "Yes. We provide lead testing services, which is especially critical for schools, daycares, and residential complexes built before 1978 undergoing renovation." },
      { question: "How fast can I get environmental test results?", answer: "Turnaround depends on the test. ATP is instant. Asbestos and mold lab results can often be rushed in 24 hours. Complex chemical analysis may take longer." },
      { question: "Do you perform the abatement?", answer: "We are primarily a restoration and testing company. For asbestos and lead abatement, we partner with licensed abatement specialists, then we perform the final clearance testing and reconstruction." },
      { question: "Is your testing legally defensible?", answer: "Yes. We follow strict chain-of-custody protocols for all samples sent to accredited independent laboratories, ensuring the results are valid for legal or insurance purposes." }
    ],
